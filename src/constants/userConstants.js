...
const FETCH_CATEGORIES_CHART__REQUEST = "FETCH_CATEGORIES_CHART__REQUEST";
const FETCH_CATEGORIES_CHART__SUCCESS = "FETCH_CATEGORIES_CHART__SUCCESS";
const FETCH_CATEGORIES_CHART__FAIL = "FETCH_CATEGORIES_CHART__FAIL";

const FETCH_GROUP_CHART__REQUEST = "FETCH_GROUP_CHART__REQUEST";
const FETCH_GROUP_CHART__SUCCESS = "FETCH_GROUP_CHART__SUCCESS";
const FETCH_GROUP_CHART__FAIL = "FETCH_GROUP_CHART__FAIL";

const FETCH_SPENDS_CHART__REQUEST = "FETCH_SPENDS_CHART__REQUEST";
const FETCH_SPENDS_CHART__SUCCESS = "FETCH_SPENDS_CHART__SUCCESS";
const FETCH_SPENDS_CHART__FAIL = "FETCH_SPENDS_CHART__FAIL";

const ADD_SETTLEMENT__REQUEST = "ADD_SETTLEMENT__REQUEST";
const ADD_SETTLEMENT__SUCCESS = "ADD_SETTLEMENT__SUCCESS";
const ADD_SETTLEMENT__FAIL = "ADD_SETTLEMENT__FAIL";

const FETCH_SETTLEMENTS__REQUEST = "FETCH_SETTLEMENTS__REQUEST";
const FETCH_SETTLEMENTS__SUCCESS = "FETCH_SETTLEMENTS__SUCCESS";
const FETCH_SETTLEMENTS__FAIL = "FETCH_SETTLEMENTS__FAIL";
