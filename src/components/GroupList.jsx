        ...
        <TouchableNativeFeedback onPress={() => { navigation.navigate('GroupMainScreen', { data }) }}>
            <View className='flex-row mx-[20px] mt-[17px]'>
                ...
                <View className='mx-[10px] justify-center'>
                    ...
                    {total > 0 ?
                        <Text className='text-[#03a37e] text-[16px] font-[Poppins-Medium]'>you are owed ₹{total}</Text>
                        :
                        <Text className='text-[#ed4f00] text-[16px] font-[Poppins-Medium]'>you owe ₹{-total}</Text>
                    }
