		...
		<View className="flex-1">
			...
			<View>
				<View className='my-5 mx-5 flex-row items-center'>
					...
					<TextInput className='flex-1 text-[Poppins-Medium] text-lg ' label={<Text className='text-lg font-[Poppins-Medium]'>Group name</Text>} mode='outlined' outlineColor='#5A5A5A' underlineColor='' activeOutlineColor='#5A5A5A' autoFocus outlineStyle={{ backgroundColor: 'white', borderBottomWidth: 2, borderWidth: 0, borderRadius: 0 }} />
				</View>
				<View>
